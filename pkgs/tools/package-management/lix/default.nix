...
lib.makeExtensible (
  self:
  {
    ...
    git = self.makeLixScope {
      ...
      lix-args = rec {
        version = "2.95.0-pre-20251119_${builtins.substring 0 12 src.rev}";

        src = fetchFromGitea {
          domain = "git.lix.systems";
          owner = "lix-project";
          repo = "lix";
          rev = "04a4b159916dcd33e5708fa6c84b1a49b9d07248";
          hash = "sha256-mvWq3rMIpYOuPp23PbQLxe8riiq5vqT6FWjTDSlQGjI=";
        };
